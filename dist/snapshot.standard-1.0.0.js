...
( function ( global, $ ) {
    ...
    const HtmlFactory = __webpack_require__(13);
...
const nodeRule = __webpack_require__(1);
...
const Group = __webpack_require__(11);
...
const noteRule = __webpack_require__(1);
...
//filter Configurable
__webpack_require__(15);//星号过滤
__webpack_require__(16);//s-属性
__webpack_require__(17);//不可见元素

__webpack_require__(18);//清理已不需要的信息
__webpack_require__(19);//宽度
__webpack_require__(20);//空壳note升级
